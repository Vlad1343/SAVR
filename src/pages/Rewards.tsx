    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border bg-card sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link to="/rewards" className="text-sm font-medium text-foreground">Rewards</Link>
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Redeem your points for exclusive perks</p>
        </div>

        <div className="text-center py-20">
          <Gift className="w-24 h-24 text-muted-foreground mx-auto mb-6 opacity-50" />
          <h2 className="text-2xl font-bold mb-2">Rewards Coming Soon</h2>
          <p className="text-muted-foreground">Complete challenges to unlock amazing rewards</p>
        </div>
      </div>
    </div>
  );
