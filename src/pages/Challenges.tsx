...
import { Sparkles, Target, Trophy, Flame, Award } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b border-border bg-card sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link to="/challenges" className="text-sm font-medium text-foreground">Challenges</Link>
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Smart Challenges</h1>
          <p className="text-muted-foreground">Complete challenges. Earn points. Build streaks.</p>
        </div>
        ...
        <div className="text-center py-20">
          ...
          <p className="text-muted-foreground mb-8">Upload a bank statement to get personalized challenges</p>
          <Link to="/upload">
